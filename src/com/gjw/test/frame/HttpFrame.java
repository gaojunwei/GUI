...
import com.gjw.test.service.ReqService;
	...
	public static void init() {
        ...
        sendReq_btn.addActionListener(new ActionListener()
        {
        	public void actionPerformed(ActionEvent arg0)
            {
        		...
        		Utile.getInstance().getFullUrl(req_addr_str);
        		
        		text_area.append("请求地址："+req_addr_str+"\n");
        		text_area.append("请求参数："+req_params_str+"\n");
        		
        		String result = ReqService.sendReq(req_addr_str, req_params_str);
